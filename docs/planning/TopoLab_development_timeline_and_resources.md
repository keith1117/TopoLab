...
Chinese reading companion: [开发周期与资源评估](./TopoLab_开发周期与资源评估.md).
Related documents: [Admissions fit](./TopoLab_admissions_fit_assessment.md) · [Numerical Core reimplementation strategy](./TopoLab_reimplementation_strategy.md)

Current v2 scheduling override: this document retains the original estimates
and `v1.0.0` closeout as historical planning evidence. The active
[v2 roadmap](./TopoLab_v2_development_roadmap.md) makes reproducible
...
report, and a demo. Full v2 flagship delivery additionally requires the positive
...
v2 flagship project has not met its delivery condition.
