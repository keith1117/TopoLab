...
生成器版本、数据分割和 baseline。前十个 M0 切片已在
...
`docs/validation/m0_catalog_materialization.md`。因此 M0 gate 仍未通过，在修订
termination budget、生成新 identity 并获得零失败 materialization 前不能开始模型
训练。
