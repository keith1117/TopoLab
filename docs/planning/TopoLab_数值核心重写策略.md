...
English version: [Numerical Core Reimplementation Strategy](./TopoLab_reimplementation_strategy.md)

相关文档：[美研申请匹配度评估](./TopoLab_美研申请匹配度评估.md) · [开发周期与资源评估](./TopoLab_开发周期与资源评估.md)
